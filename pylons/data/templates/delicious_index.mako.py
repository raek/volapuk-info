...
_magic_number = 5
_modified_time = 1261612075.04196
_template_filename='/home/raek/Projekt/volapuk-info/pylons/volapuksite/templates/delicious_index.mako'
_template_uri='/delicious_index.mako'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\n')
        # SOURCE LINE 7
        __M_writer(u'\n      <table>\n        <tr><th>Username</th><th>Count</th><th>Last checked</th><th>Actions</th></tr>\n')
        # SOURCE LINE 10
        for account in c.accounts:
            ...
            __M_writer(u'</td>\n          <td>')
            # SOURCE LINE 14
            __M_writer(escape(h.time_ago_in_words(account.last_checked, 'hour')))
            __M_writer(u' ago</td>\n          <td>\n            <a href="')
            # SOURCE LINE 16
            __M_writer(escape(h.url_for(action='view', id=account.id)))
            __M_writer(u'">View</a>\n            <a href="')
            ...
            # SOURCE LINE 21
            __M_writer(escape(h.url_for(action='update', id=account.id)))
